...
public class Choose_Roomtype_Button {
    public static void main(String[] args) {

        BorisDataBaseJDBC s_c = new BorisDataBaseJDBC();
        ...
        try (Connection conn = DriverManager.getConnection(s_c.URL, s_c.USER, s_c.PASSWORD);
